...
* DONE 大型网站技术架构读书笔记 :architecture:web:reading:
...
* DONE 《Chris Richardson 谈微服务软件架构设计》笔记 :microservices:architecture:reading:
...
* DONE Tips for conducting a Systematic Literature Review :slr:research:
...
* DONE 什么会和“Ops”碰撞出火花？ :devops:aiops:
...
- [[http://devopsagenda.techtarget.com/opinion/The-DevOps-concept-NoOps-DataOps-and-what-comes-next][The DevOps concept: NoOps, DataOps and what comes next]]
#+END_QUOTE
* DONE 智能时代的新运维「CNUTCon 2017 上海」 :aiops:devops:
...
#+END_SRC
* DONE How to choose an open source license? :license:open_source:
...
echo 3 >/proc/sys/vm/drop_caches
  #+END_SRC
* DONE 关于《自控力》 :self_control:reading:
...
#+END_SRC
* DONE 如何成为卓有成效的管理者？ :management:reading:
...
* DONE AIOps 简介 :aiops:
CLOSED: [2020-06-20 Sat 21:21]
:PROPERTIES:
:EXPORT_FILE_NAME: aiops-introduction
:END:
...
* DONE 内部效度，外部效度，构念效度和统计结论效度 :validity:
CLOSED: [2021-08-26 Thu 23:39]
:PROPERTIES:
:EXPORT_FILE_NAME: validity-introduction
:END:
...
[[/validity-introduction/internal-external.png]]
...
[[/validity-introduction/validity.png]]

#+begin_quote
- [[https://www.opentextbooks.org.hk/ditatopic/36007][研究设计的关键属性]]
#+end_quote
